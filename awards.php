		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3">
				  ...
				  <ul id="sideTabs" class="nav nav-tabs" role="tablist">
				    <li role="presentation" class="active">
				    	<a href="#home" aria-controls="home" role="tab" data-toggle="tab">Intro</a>
				    </li>
				    <li role="presentation">
				    	<a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Details</a>
				    </li>
				    <li role="presentation">
				    	<a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Virgina Cha</a>
				    </li>
				    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">Application</a></li>
				  </ul>
				</div>
				<div class="col-lg-9 tab-content">
					...
					<div role="tabpanel" class="tab-pane text-center" id="profile"><img src="http://www.scorpioncomputerservices.com/Extraordinary%20Ability/01eb1_details01.png" /></div>
