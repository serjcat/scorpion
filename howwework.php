			...
			<div class="row">
				...
				<div class="col-lg-8 tab-content">
					<div role="tabpanel" class="tab-pane active" id="client">
						...
						<hr>
						<p><strong>We have many options on how you may wish to get to know us - here are some:</strong></p>
						<h4>The Analysis</h4>
					...
					<div role="tabpanel" class="tab-pane" id="consultants" />
						...
						<p><a href="./join_scorpion" class="btn btn-primary">Submit Resume</a></p> 
					</div>
					<div role="tabpanel" class="tab-pane" id="ambassador">
						...
						<p><a href="mailto:usa@scorpioncomputerservices.com" class="btn btn-primary">Become a Scorpion Ambassador</a>
					</div>
