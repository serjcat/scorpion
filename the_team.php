			...
			<div class="row text-center">
				<div class="col-lg-4 text-center">
					<div class="team">
						...
						<p><strong>Projects:</strong> 360</p>
						<p><strong>Country of Origin:</strong> Ireland</p>
						<p class="text-center">
							<a href="./bio-walter" class="btn btn-primary">View Bio</a>
						</p>
					</div>
				</div>
				<div class="col-lg-4 text-center">
					<div class="team">
						...
						<p><strong>Country of Origin:</strong> Canada & United States</p>
						<p class="text-center">
							<a href="./bio-harold" class="btn btn-primary">View Bio</a>
						</p>
					</div>
				</div>
				<div class="col-lg-4 text-center">
					<div class="team">
						...
						<p class="text-center">
							<a href="./bio-logan" class="btn btn-primary">View Bio</a>
						</p>
					</div>
				</div>
			</div>
			<div class="row text-center">
				<div class="col-lg-4 col-md-6">
					<div class="team">
						...
						<p><strong>Projects:</strong> 35</p>
						<p><strong>Country of Origin:</strong> United States</p>
						<p class="text-center">
							<a href="./bio-stacy" class="btn btn-primary">View Bio</a>
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="team">
						...
						<p class="text-center">
							<a href="./bio-hanson" class="btn btn-primary">View Bio</a>
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
			...
			<div class="row text-center">
				...
				<div class="col-lg-4 col-md-6">
					<div class="team">
						...
						<p><strong>Years in it:</strong> 2.5</p>
